...
import 'package:gais/screen/approval/actualization_trip/list/approval_actualization_trip_list_controller.dart';
import 'package:gais/util/enum/approval_action_enum.dart';
import 'package:gais/util/enum/status_enum.dart';
import 'package:gais/util/ext/string_ext.dart';
import 'package:get/get.dart';

class ApprovalActualizationTripListScreen extends StatelessWidget {
  const ApprovalActualizationTripListScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final ApprovalActualizationTripListController controller =
        Get.put(ApprovalActualizationTripListController());
