...
class ApprovalHistoryRequestTripListScreen extends StatelessWidget {
  const ApprovalHistoryRequestTripListScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final ApprovalHistoryRequestTripListController controller =
        Get.put(ApprovalHistoryRequestTripListController());
