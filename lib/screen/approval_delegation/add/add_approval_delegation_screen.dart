...
class AddApprovalDelegationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final AddApprovalDelegationController controller = Get.put(AddApprovalDelegationController());
                  ...
                  CustomTextFormField(
                      ...
                      onTap: () {
                        ...
                        showDatePicker(
                          ...
                          print("controller.startDate.value ${controller.startDate.value}");
                          controller.update();
                        });
                      },
                  ...
                  CustomTextFormField(
                      ...
                      onTap: () {
                        ...
                        if (controller.startDate.value == null) {
                          ...
                          print("controller.startDate.values ${controller.startDate.value}");
