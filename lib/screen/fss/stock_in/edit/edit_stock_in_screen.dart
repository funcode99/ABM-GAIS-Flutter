...
import 'package:gais/screen/fss/stock_in/edit/edit_stock_in_controller.dart';
import 'package:get/get.dart';
import 'package:iconly/iconly.dart';

class EditStockInScreen extends StatelessWidget {
  const EditStockInScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final EditStockInController controller =
    Get.put(EditStockInController());
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    OutlinedButton(
                      onPressed: () {
                        controller.onEditButtonPressed();
                      },
                    ...
                    Obx(() {
                      print("BOOL VALUE ${controller.isOnEdit.value}");
                      ...
                      children: [
                        ...controller.listItem
                            ...
                            CommonListItem(
                              ...
                              action: controller.isOnEdit.value ?
                              [
                              CustomIconButton(
                                title: "Edit".tr,
