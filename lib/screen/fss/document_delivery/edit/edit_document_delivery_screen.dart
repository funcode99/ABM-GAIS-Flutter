...
import 'package:gais/screen/fss/document_delivery/edit/edit_document_delivery_controller.dart';
import 'package:get/get.dart';
import 'package:iconly/iconly.dart';

class EditDocumentDeliveryScreen extends StatelessWidget {
  const EditDocumentDeliveryScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetBuilder<EditDocumentDeliveryController>(
        init: EditDocumentDeliveryController(),
        builder: (controller) {
          return Scaffold(
            appBar: TopBar(
