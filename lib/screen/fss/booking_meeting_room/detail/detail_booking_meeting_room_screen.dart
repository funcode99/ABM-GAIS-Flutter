                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Row(
                          children: [
                            ...
                            //approval
                            Obx(() {
                              if((controller.selectedItem.value.isApproval ?? false) && ((controller.selectedItem.value.nameApproved != null && controller.selectedItem.value.approvedAt != null) || (controller.selectedItem.value.nameRejected != null && controller.selectedItem.value.rejectedAt != null))){
                                return GestureDetector(
                                  child: Container(
                                    padding: const EdgeInsets.symmetric(
                                        horizontal: 16),
