...
class ActualizationTripListController extends BaseController with MasterDataMixin{
  ...
  final listHeader = <ActualizationTripModel>[].obs;
  ...
  void initData()async{
    ...
    listStatus.add(StatusDocModel(code: 4, status: "Reject"));
  ...
  void getHeader({int page = 1}) async {
    ...
    result.fold(
          ...
          listHeader.value = paginationModel!.data!
              .map((e) => ActualizationTripModel.fromJson(e))
              .toList();
          listHeader.refresh();
        });
  }
  ...
  void deleteHeader(ActualizationTripModel item) async {
