class GetActualBytripidModel {
  GetActualBytripidModel({
      bool? success, 
      String? message, 
      List<Data>? data,}){
    _success = success;
  ...
  GetActualBytripidModel.fromJson(dynamic json) {
  ...
  String? _message;
  List<Data>? _data;
GetActualBytripidModel copyWith({  bool? success,
  String? message,
  List<Data>? data,
}) => GetActualBytripidModel(  success: success ?? _success,
...
Data copyWith({  num? no,
  ...
  dynamic get daysOfTrip => _daysOfTrip;
