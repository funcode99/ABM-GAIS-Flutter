...
class GetFlightScheduleModel {
  GetFlightScheduleModel({
      bool? success, 
      String? message, 
      List<Data>? data,}){
    _success = success;
  ...
  GetFlightScheduleModel.fromJson(dynamic json) {
  ...
  String? _message;
  List<Data>? _data;
GetFlightScheduleModel copyWith({  bool? success,
  String? message,
  List<Data>? data,
}) => GetFlightScheduleModel(  success: success ?? _success,
