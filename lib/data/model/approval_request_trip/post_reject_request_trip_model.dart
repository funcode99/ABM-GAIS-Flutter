...
/// data : {"id":191,"code_document":"SV","id_document":120,"level":1,"id_employee":null,"id_company":1,"id_site":18,"id_matrix":17,"id_approval_auth":2,"approved_by":5,"approved_behalf":null,"rejected_by":5,"is_approved":0,"notes":null,"code_status_doc":2,"is_request_trip":1,"code_sequence":"RTRIP","created_at":"2023-06-18T09:43:54.000000Z","created_by":null,"updated_at":"2023-06-19T07:22:06.000000Z","updated_by":null,"deleted_at":null}

class PostRejectRequestTripModel {
  PostRejectRequestTripModel({
      bool? success, 
      String? message, 
      Data? data,}){
    _success = success;
  ...
  PostRejectRequestTripModel.fromJson(dynamic json) {
  ...
  String? _message;
  Data? _data;
PostRejectRequestTripModel copyWith({  bool? success,
  String? message,
  Data? data,
}) => PostRejectRequestTripModel(  success: success ?? _success,
...
/// is_request_trip : 1
/// code_sequence : "RTRIP"
/// created_at : "2023-06-18T09:43:54.000000Z"
/// created_by : null
/// updated_at : "2023-06-19T07:22:06.000000Z"
/// updated_by : null
/// deleted_at : null
