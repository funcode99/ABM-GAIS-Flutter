class GetAirportScheduleModel {
  ...
  GetAirportScheduleModel copyWith({
    bool? success,
    String? message,
    Data? data,
  }) =>
...
class Flights {
  Flights({
    ...
    _showTransit = showTransit;

  }

  bool get showTransit => _showTransit!;

  set showTransit(bool value) {
    _showTransit = value;
  }
  ...
  Flights copyWith({
    ...
    bool? showTransit,
      ...
      Flights(
        ...
        showTransit: showTransit ?? _showTransit,
      );
