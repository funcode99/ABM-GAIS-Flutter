...
/// data : [{"id":1,"id_request_trip":2,"id_type_accomodation":1,"check_in_date":"2023-01-01","check_out_date":"2023-02-02","id_vendor":1,"use_gl":1,"id_city":1,"sharing_w_name":"1","remarks":"1","price":"1000000","code_hotel":"1","code_status_doc":0,"created_at":"2023-05-19 05:44:19","created_by":"2","updated_at":"2023-05-19 05:44:19","updated_by":null}]

class GetAccommodationBytripModel {
  GetAccommodationBytripModel({
      bool? success, 
      String? message, 
      List<Data>? data,}){
    _success = success;
  ...
  GetAccommodationBytripModel.fromJson(dynamic json) {
  ...
  String? _message;
  List<Data>? _data;
GetAccommodationBytripModel copyWith({  bool? success,
  String? message,
  List<Data>? data,
}) => GetAccommodationBytripModel(  success: success ?? _success,
